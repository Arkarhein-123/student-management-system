...
export default function Register({ onClose = () => {}, onSwitchToLogin = () => {} }: RegisterModalProps) {
    ...
    const onSubmit = async (data: RegisterFormValues) => {
        try {
            ...
            if (error.response?.status === 400 || error.response?.status === 409) {
                ...
                setError("email", {
                    type: "manual",
                    message: backendMessage || "This email address or username is already registered.",
                });
            } else {
                setError("root", {
    ...
    return (
        <Card className="w-full border-none bg-white shadow-2xl rounded-2xl">
            ...
            <CardContent className="space-y-4">
                ...
                <div className="relative flex items-center justify-center text-xs uppercase tracking-wider text-slate-400 my-2">
