...
export default function StudentRegisteredClassroomsPage() {
    ...
    // Extract the live user object from Zustand state
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="relative aspect-video w-full bg-slate-100 overflow-hidden">
                                    ...
                                    />
                                    <span
                                        className={`absolute top-4 left-4 px-2.5 py-1 text-[10px] font-black uppercase tracking-wider rounded-md shadow-xs
                                        ${
                                            isApproved
                                ...
                                <div className="p-5 flex-1 flex flex-col justify-between space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex justify-between items-center text-xs font-bold">
                                                ...
                                                <span className="text-blue-600">
                                                    {classroom.progressPercent}% Complete
                                                </span>
                                            </div>
                                    ...
                                    <button
                                        ...
                                        disabled={!isApproved}
                                        className={`w-full py-3 px-4 text-xs font-bold rounded-xl transition duration-150 shadow-2xs tracking-wide text-center
                                            ${
                                                isApproved
                                    ...
                                    >
                                        {isApproved ? "[Resume Lecture Course →]" : "[Awaiting Approval]"}
                                    </button>
                                </div>
                            </div>
                        );
